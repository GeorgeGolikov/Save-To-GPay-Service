...
public class RestMethods {
    ...
    *******************************/
    ...
    public GenericJson updateOfferClass(String classId, OfferClass offerClass) {
        GenericJson response = null;
        GoogleCredential credentials = makeOauthCredential();
        Config config = Config.getInstance();
        ...
        try {
            response = client.offerclass().patch(classId, offerClass).execute();
            response.put("code",200);
            // System.out.println(response);
        } catch (GoogleJsonResponseException gException)  {
            System.out.println(">>>> [START] Google Server Error response:");
    ...
    public GenericJson updateLoyaltyClass(String classId, LoyaltyClass loyaltyClass) {
        GenericJson response = null;
        GoogleCredential credentials = makeOauthCredential();
        Config config = Config.getInstance();
        ...
        try {
            response = client.loyaltyclass().patch(classId, loyaltyClass).execute();
            response.put("code",200);
            // System.out.println(response);
        } catch (GoogleJsonResponseException gException)  {
            System.out.println(">>>> [START] Google Server Error response:");
