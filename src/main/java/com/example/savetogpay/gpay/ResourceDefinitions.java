...
public class ResourceDefinitions {
     ...
     *
     *******************************/
    public OfferClass makeOfferClassResource(String classId, CardClassAttributesDto cardClassAttributes) {
        ...
        OfferClass payload = new OfferClass()
                // required
                .setId(classId)
                .setIssuerName(cardClassAttributes.getIssuerName())
                .setProvider(cardClassAttributes.getProvider())
                .setRedemptionChannel(cardClassAttributes.getRedemptionChannel())
                .setReviewStatus(cardClassAttributes.getReviewStatus())
                .setTitle(cardClassAttributes.getTitle())
     ...
     *
     *******************************/
    public OfferObject makeOfferObjectResource(String classId, String objectId, CardObjectAttributesDto cardObjectAttributes) {
        ...
        OfferObject payload = new OfferObject()
                // required
                .setClassId(classId).setId(objectId)
     ...
     *
     *******************************/
    public LoyaltyClass makeLoyaltyClassResource(String classId, CardClassAttributesDto cardClassAttributes) {
        // Define the resource representation of the Class
        // values should be from your DB/services; here we hardcode information
        ...
        LoyaltyClass payload = new LoyaltyClass()
                ...
                .setId(classId)
                .setIssuerName(cardClassAttributes.getIssuerName())
                .setProgramName(cardClassAttributes.getProgramName())
                .setProgramLogo(
                        new Image().setSourceUri(
                            new ImageUri().setUri(cardClassAttributes.getImageUri())
                        )
